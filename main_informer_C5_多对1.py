...
def initialize_parameter():
    ...
    parser.add_argument('--loss', type=str, default='huberloss', help='损失函数选项：loss function【mse、huberloss、L1loss】--------------------损失函数')
    ...
    parser.add_argument('--data', type=str, required=False, default='C5', help='data them，取决了在data parse中寻找的是哪个数据文件的配置,很重要')
...
if __name__ == '__main__':
    ...
    for ii in range(args.itr):
        ...
        # setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(ii+1,
